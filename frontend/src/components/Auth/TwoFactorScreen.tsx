      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            disabled={isLoading}
            className="w-full rounded-3xl bg-[#4d8eff] px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-[#3a6cd9] disabled:opacity-80 dark:bg-[#4d8eff] dark:hover:bg-[#3a6cd9]"
          >
