        ...
        <div className="relative">
          <Trigger asChild>
            <button
              ...
              className={cn(
                'relative flex flex-col rounded-md border border-black/10 bg-white/50 py-2 pl-3 pr-10 text-left focus:outline-none focus:ring-0 focus:ring-offset-0 dark:border-gray-700 dark:bg-[#1f2937]/50 sm:text-sm',
                'pointer-cursor font-normal',
                'hover:bg-blue-75 radix-state-open:bg-blue-75 dark:hover:bg-[#2a3a4a] dark:radix-state-open:bg-[#2a3a4a]',
              )}
            >
              {' '}
              {showLabel && (
