      ...
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ...
          className={cn(
            ...
            'dark:bg-gray-700',
            isSmallScreen
              ? 'fixed left-1/2 top-1/2 z-[999] m-auto grid w-11/12 -translate-x-1/2 -translate-y-1/2 gap-4 rounded-2xl bg-white pb-6'
              : '',
