    ...
    return (
      <a
        ...
        rel="noopener noreferrer"
                    className="flex w-full flex-col rounded-lg bg-surface-primary-contrast px-3 py-2 text-sm transition-all duration-300 hover:bg-blue-75 dark:hover:bg-[#16213e]"
      >
          ...
          <Ariakit.HovercardAnchor
            render={
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-full w-full flex-col rounded-lg bg-surface-primary-contrast px-3 py-2 text-sm transition-all duration-300 hover:bg-blue-75 dark:hover:bg-[#16213e]"
              >
                <div className="flex items-center gap-2">
                  <FaviconImage domain={domain} />
                  <span className="truncate text-xs font-medium text-text-secondary">{domain}</span>
...
function ImageItem({ image }: { image: ImageResult }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="group overflow-hidden rounded-lg bg-surface-secondary transition-all duration-300 hover:bg-blue-75 dark:hover:bg-[#16213e]"
    >
      {image.imageUrl && (
  ...
  return (
    <div className="scrollbar-none grid w-full grid-cols-4 gap-2 overflow-x-auto">
      <OGDialog>
        ...
        {hasMoreSources && (
          <OGDialogTrigger className="flex flex-col rounded-lg bg-surface-primary-contrast px-3 py-2 text-sm transition-all duration-300 hover:bg-blue-75 dark:hover:bg-[#16213e]">
            <div className="flex items-center gap-2">
        ...
        <OGDialogContent className="flex max-h-[80vh] max-w-full flex-col overflow-hidden rounded-lg bg-surface-primary p-0 md:max-w-[600px]">
          <div className="sticky top-0 z-10 flex items-center justify-between border-b border-border-light bg-surface-primary px-3 py-2">
            ...
            <OGDialogClose
              className="rounded-full p-1 text-text-secondary hover:bg-blue-75 dark:hover:bg-[#16213e] hover:text-text-primary"
            ...
            <div className="flex flex-col gap-2">
              {[...visibleSources, ...remainingSources].map((source, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex gap-2 rounded-lg px-2 py-2 transition-colors hover:bg-blue-75 dark:hover:bg-[#16213e]"
                >
                  <FaviconImage
                    domain={getCleanDomain(source.link)}
...
function TabWithIcon({ label, icon }: { label: string; icon: React.ReactNode }) {
  return (
    <div className="flex items-center gap-2 rounded-md px-3 py-1 text-sm transition-colors hover:bg-blue-75 dark:hover:bg-[#16213e] hover:text-text-primary">
