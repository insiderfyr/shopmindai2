        ...
        buttons={
          <>
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-lg border border-border-heavy bg-surface-secondary px-4 py-2 text-sm text-text-primary hover:bg-[#4d8eff] hover:text-white focus:bg-[#4d8eff] focus:text-white dark:hover:bg-[#3a6cd9] dark:focus:bg-[#3a6cd9]"
            >
