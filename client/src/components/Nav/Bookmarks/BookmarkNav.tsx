            ...
            render={
              <MenuButton
                ...
                className={cn(
                  ...
                  'size-10 border-none text-text-primary hover:bg-blue-50 dark:hover:bg-[#2a3a4a] hover:text-accent-foreground',
                                      'rounded-full border-none p-2 hover:bg-blue-50 dark:hover:bg-[#2a3a4a] md:rounded-xl',
