...
export default function StaticSidebarButton({ type, setNavVisible }: StaticSidebarButtonProps) {
    ...
    if (type === 'newchat') {
      return (
        <svg 
          ...
          className="w-6 h-6 text-gray-700 dark:text-gray-300 cursor-pointer group-hover:text-gray-900 dark:group-hover:text-gray-100 transition-colors duration-300"
          fill="currentColor" 
          viewBox="0 0 24 24"
          ...
          tabIndex={0}
        >
          <path fillRule="evenodd" d="M6.416 4.767a2.65 2.65 0 0 0-2.65 2.65v8.832a2.65 2.65 0 0 0 2.65 2.65h1.461V4.767h-1.46Zm0-1.767A4.416 4.416 0 0 0 2 7.416v8.833a4.416 4.416 0 0 0 4.416 4.417h11.168A4.416 4.416 0 0 0 22 16.248V7.416A4.416 4.416 0 0 0 17.584 3zm3.228 1.767v14.132h7.94a2.65 2.65 0 0 0 2.65-2.65V7.416a2.65 2.65 0 0 0-2.65-2.65h-7.94Z" clipRule="evenodd"/>
        </svg>
      );
    }
  ...
  return (
    <TooltipAnchor
      ...
      side="bottom"
      render={
        <div className="group relative p-2 rounded-lg hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-300 ease-out hover:shadow-lg">
          {getIcon()}
        </div>
      }
    />
