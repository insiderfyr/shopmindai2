      ...
      <Dialog as="div" className="relative z-50" onClose={onOpenChange}>
        ...
        >
          <div className={cn('fixed inset-0 flex w-screen items-center justify-center p-4')}>
            <DialogPanel
              className={cn(
                'min-h-[600px] overflow-hidden rounded-md rounded-b-lg bg-white pb-6 shadow-2xl backdrop-blur-2xl animate-in dark:bg-[#182533] sm:rounded-md md:min-h-[373px] md:w-[680px]',
              )}
            >
              <DialogTitle
                ...
                >
                  <Tabs.List
                    ...
                    className={cn(
                      ...
                      isSmallScreen
                        ? 'flex-row rounded-md bg-white dark:bg-[#0f1a2a]'
                        : 'sticky top-0 h-full',
                    )}
                    ...
                    {settingsTabs.map(({ value, icon, label }) => (
                      <Tabs.Trigger
                        ...
                        className={cn(
                          ...
                          isSmallScreen
                            ? 'flex-1 justify-center text-nowrap p-1 px-3 text-sm text-text-secondary radix-state-active:bg-white radix-state-active:text-text-primary dark:radix-state-active:bg-[#182533]'
                            : 'bg-transparent text-text-secondary radix-state-active:bg-white radix-state-active:text-text-primary dark:radix-state-active:bg-[#182533]',
                        )}
                        value={value}
                  ...
                  <div className="overflow-auto bg-white dark:bg-[#182533] sm:w-full sm:max-w-none md:pr-0.5 md:pt-0.5">
