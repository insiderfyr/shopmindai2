          ...
          <TooltipAnchor
            ...
            render={
              <Ariakit.MenuButton
                ...
                className="inline-flex size-10 flex-shrink-0 items-center justify-center rounded-md border border-border-light bg-transparent text-text-primary transition-all ease-in-out hover:bg-surface-tertiary disabled:pointer-events-none disabled:opacity-50 radix-state-open:bg-surface-tertiary"
              >
                <Share2
