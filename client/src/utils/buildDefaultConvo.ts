...
const buildDefaultConvo = ({
  ...
  // Check for specific invalid endpoint "data"
  if (endpoint && typeof endpoint === "string" && endpoint === "data") {
    console.warn("buildDefaultConvo: Detected invalid endpoint \"data\", likely from query parameter. Falling back to null.");
    return {
      ...conversation,
      endpointType,
      endpoint: null,
